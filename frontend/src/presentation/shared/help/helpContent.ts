...
export const helpEntries: readonly HelpEntry[] = [
  ...
  },
  {
    ...
    summary: '공고를 고르면 공식 첨부(PDF·HWP·HWPX)에서 신청 양식과 문항을 찾고, 문항마다 답한 내용을 AI가 사실로 정리해 확인한 것만 저장합니다.',
    body: [
      '기업마당·K-Startup·과기정통부·충남 수출지원 공고만 지원합니다. 관심 공고함에서 고르거나 전체 공고를 검색해 선택합니다.',
      '첨부 분석은 대기열에서 처리되며 화면이 3초마다 진행을 확인합니다. 발견한 양식을 확인해야 문항 작성으로 넘어갑니다.',
      '문항에 답하면 AI가 사실과 미정 항목으로 나눠 제안하고, 값과 근거를 확인한 항목만 입력 스냅샷으로 저장됩니다. 저장할 때마다 입력 버전이 올라갑니다.',
    ],
    limitation: '완성된 신청서 초안 생성·수정은 아직 제공하지 않습니다. 스캔 PDF와 암호화된 첨부는 읽지 못합니다.',
    category: 'screen',
    surfaces: ['guide', 'faq', 'manual', 'chatbot'],
    audience: 'member',
