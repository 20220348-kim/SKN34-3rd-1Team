...
진행 패널(`shared/chat-activity/ChatActivityPanel`)이 점·상태(검색 중, 조건 해석 중, 결과 N건 도착, 실패 등)·대화 제목·"보기" 링크를 보여 주고,
검색 중인 대화의 기록 항목에도 같은 점이 붙습니다. 사이드바를 접었거나 모바일·공개 헤더에서는 헤더 칩이 같은 상태를 알립니다.
결과가 도착하면 오른쪽 위 헤더 아래에 한 줄 알림(12초 뒤 자동 접힘, "대화 보기"로 이동)을 띄웁니다.
